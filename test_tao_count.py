...
parser = argparse.ArgumentParser("Testing on TAO-Count", add_help=False)
parser.add_argument(
    "--output_file", type=str, default="tao-count-predicted.json", help="file where to save predicted counts"
)
parser.add_argument(
  "--data_dir", type=str, default="VideoCount/TAO-Count", help="path to TAO-Count dataset"
)
parser.add_argument(
    "--checkpoint_dir",
    type=str,
