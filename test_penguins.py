...
parser = argparse.ArgumentParser("Testing on Penguins", add_help=False)
parser.add_argument(
    "--output_file", type=str, default="penguins-count-predicted.json", help="file where to save predicted counts"
)
parser.add_argument(
  "--data_dir", type=str, default="VideoCount/Penguins", help="path to Penguins dataset"
)
parser.add_argument(
    "--checkpoint_dir",
    type=str,
