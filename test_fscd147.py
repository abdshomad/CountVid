# Taken from: https://github.com/jerpelhan/DAVE/blob/0d6015c401ca19b96272940a0e32394fb8e755ec/utils/eval.py
...
def get_args_parser():
    ...
    parser.add_argument("--gt", required=True, type=str, help="ground truth COCO file path")
    parser.add_argument("--pred", required=True, type=str, help="predicted COCO file path")
    parser.add_argument("--split", required=True, type=str, help="data split ['val', 'test']")
...
if __name__ == "__main__":
    ...
    split = args.split
    counting_json_path = "./FSC147_384_V2/annotations/annotation_FSC147_384.json"

    print("Evaluating on " + args.split + " set")
